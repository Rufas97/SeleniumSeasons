...
public class MultipleWindows2 {
	...
	private void swithToWindow(String expectedTitle) {
	...
	public void multipeWindowsTest() throws InterruptedException
	{
		...
		swithToWindow("Free CRM Trial: Salesforce 30-Day Trial - Salesforce IN");
		
		
		
		driver.findElement(By.xpath("//input[@name='UserFirstName']")).sendKeys("Rufas");
		...
		swithToWindow("Salesforce Overview Demos - Salesforce IN");
